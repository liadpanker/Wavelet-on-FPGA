...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../proj_wavelets.gen/sources_1/bd/system/ipshared/7698" \
       +incdir+"$ref_dir/../../../../proj_wavelets.gen/sources_1/bd/system/ipshared/8713/hdl" \
       +incdir+"$ref_dir/../../../../proj_wavelets.gen/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../proj_wavelets.gen/sources_1/bd/system/ipshared/ee60/hdl" \
       +incdir+"../../../../proj_wavelets.gen/sources_1/bd/system/ipshared/7698" \
       +incdir+"../../../../proj_wavelets.gen/sources_1/bd/system/ipshared/8713/hdl" \
       +incdir+"../../../../proj_wavelets.gen/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"../../../../proj_wavelets.gen/sources_1/bd/system/ipshared/ee60/hdl" \
