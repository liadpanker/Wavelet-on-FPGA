...
architecture STRUCTURE of system_debug_mux_0_1_debug_mux is
  ...
  signal \debug_mux_out[27]_i_2_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \debug_mux_out[14]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \debug_mux_out[27]_i_2\ : label is "soft_lutpair3";
  ...
  attribute SOFT_HLUTNM of \noise[0]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \noise[7]_i_1\ : label is "soft_lutpair5";
...
\debug_mux_out[0]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FCBBFC88"
    )
        port map (
...
\debug_mux_out[0]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"E200"
    )
        port map (
...
\debug_mux_out[14]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FF04"
    )
        port map (
...
\debug_mux_out[14]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"1FF0DFFF"
    )
        port map (
...
\debug_mux_out[27]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
